...
<head>
    ...
    <link rel="stylesheet" href="../public/css/cartagena/cartagena.css" />
    <style>
        .img-placeholder {
            width: 100%;
            height: 100%;
...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <h1 class="hero-title">STANDS QUE<br /><span class="accent">DOMINAN</span><br />LA FERIA</h1>
            <p class="hero-subtitle">Somos la empresa líder en diseño y montaje de stands en Cartagena de Indias. Más de 5 años transformando ideas en espacios que cautivan y convierten.</p>
            ...
            <div class="hero-stats">
                ...
                <div class="stat">
                    ...
                    <div class="stat-label">Años en Cartagena</div>
                </div>
                <div class="stat">
        ...
        <div class="hero-visual">
            ...
            <div class="hero-float-card card-1">
                ...
                <div class="fc-value">5+</div>
                <div class="fc-sub">Años en Cartagena</div>
            </div>
    ...
    <div class="venues-strip">
        <div class="strip-track">
            <span class="strip-item"><svg viewBox="0 0 24 24">
                ...
                </svg>Centro de Convenciones Julio César Turbay</span>
            <span class="strip-item"><svg viewBox="0 0 24 24">
                    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                    <polyline points="9,22 9,12 15,12 15,22" />
            ...
            <span class="strip-item"><svg viewBox="0 0 24 24">
                    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                    <polyline points="9,22 9,12 15,12 15,22" />
                </svg>Hotel Hilton Cartagena</span>
            <span class="strip-item"><svg viewBox="0 0 24 24">
                    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                    <polyline points="9,22 9,12 15,12 15,22" />
                </svg>Centro de Convenciones Julio César Turbay</span>
    ...
    <section class="about-section" id="nosotros">
        <div class="about-grid">
            <div class="reveal-left">
                <p class="section-eyebrow">Nuestra presencia en Cartagena</p>
                <h2 class="section-title">LÍDERES EN<br /><span class="accent">STANDS</span><br />CARTAGENA</h2>
                <p class="section-sub">Con más de 5 años operando en los principales recintos feriales de la ciudad, conocemos cada espacio, cada regla y cada oportunidad para hacer que tu marca brille como merece.</p>
                <div class="about-features">
                    <div class="feat">
                        ...
                        <div>
                            <div class="feat-title">Diseño 3D sin costo adicional</div>
                            <div class="feat-desc">Visualiza tu stand antes de producirlo con renders fotorrealistas incluidos en tu cotización.</div>
                        </div>
                    </div>
                    <div class="feat">
                        <div class="feat-icon"><svg viewBox="0 0 24 24">
                        ...
                        <div>
                            <div class="feat-title">Fabricación, transporte e instalación</div>
                            <div class="feat-desc">Todo incluido, sin sorpresas. Nos encargamos de cada detalle desde el taller hasta el recinto.</div>
                        </div>
                    </div>
                    <div class="feat">
                        <div class="feat-icon"><svg viewBox="0 0 24 24">
                        ...
                        <div>
                            <div class="feat-title">Soporte durante todo el evento</div>
                            <div class="feat-desc">Permanecemos disponibles para atender cualquier ajuste o imprevisto en tiempo real.</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="reveal-right">
                <div class="venues-label">Recintos donde operamos en Cartagena</div>
                <div class="venues-list">
                    <div class="venue-item">
                        <div class="venue-icon"><svg viewBox="0 0 24 24">
                                <path d="M1 22h22M3 22V8l9-6 9 6v14M9 22v-6h6v6" />
                            </svg></div>
                        <div class="venue-name-text">Centro de Convenciones Julio César Turbay Ayala</div>
                    </div>
                    <div class="venue-item">
                        <div class="venue-icon"><svg viewBox="0 0 24 24">
                                <path d="M1 22h22M3 22V8l9-6 9 6v14M9 22v-6h6v6" />
                            </svg></div>
                        <div class="venue-name-text">Hotel Las Américas · CC</div>
                    </div>
                    <div class="venue-item">
                        <div class="venue-icon"><svg viewBox="0 0 24 24">
                                <path d="M1 22h22M3 22V8l9-6 9 6v14M9 22v-6h6v6" />
                            </svg></div>
                        <div class="venue-name-text">CC Estelar Cartagena de Indias</div>
                    </div>
                    <div class="venue-item">
                        <div class="venue-icon"><svg viewBox="0 0 24 24">
                                <path d="M1 22h22M3 22V8l9-6 9 6v14M9 22v-6h6v6" />
                            </svg></div>
                        <div class="venue-name-text">Hyatt Regency Cartagena</div>
                    </div>
                    <div class="venue-item">
                        <div class="venue-icon"><svg viewBox="0 0 24 24">
                                <path d="M1 22h22M3 22V8l9-6 9 6v14M9 22v-6h6v6" />
                            </svg></div>
                        <div class="venue-name-text">Hotel Hilton Cartagena</div>
                    </div>
                    <div class="venue-item">
                        <div class="venue-icon"><svg viewBox="0 0 24 24">
                                <path d="M1 22h22M3 22V8l9-6 9 6v14M9 22v-6h6v6" />
                            </svg></div>
                        <div class="venue-name-text">Y más recintos de la ciudad</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="process-section" id="proceso">
        <div class="process-wrap">
            <div class="process-header reveal">
                ...
                <p class="section-sub">Un proceso claro y transparente para transformar tu idea en un stand que cautiva.</p>
            </div>
            <div class="steps">
                <div class="step reveal delay-1">
                    ...
                    <div class="step-desc">Analizamos tus objetivos, espacio y público objetivo.</div>
                </div>
                <div class="step reveal delay-2">
                    ...
                    <div class="step-desc">Renders fotorrealistas y ajustes hasta tu aprobación.</div>
                </div>
                <div class="step reveal delay-3">
                    ...
                    <div class="step-desc">Fabricamos e instalamos con materiales premium.</div>
                </div>
                <div class="step reveal delay-2">
                    ...
                    <div class="step-desc">Disponibles durante todo el evento para cualquier ajuste.</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="why-section" id="beneficios">
        <div class="why-grid">
            <div class="reveal-left">
                ...
                <h2 class="section-title">VENTAJAS DE<br />UN <span class="accent">STAND</span><br />PROFESIONAL</h2>
                <div class="benefits">
                    <div class="benefit">
                        <div class="benefit-num">1</div>
                        <div>
                            <div class="benefit-title">Mayor visibilidad para tu marca</div>
                            <div class="benefit-desc">Un stand bien diseñado capta la atención y eleva tu presencia, generando más oportunidades de negocio en cada feria.</div>
                        </div>
                    </div>
                    <div class="benefit">
                        ...
                        <div>
                            ...
                            <div class="benefit-desc">Diseñamos espacios que inspiran conversación y despiertan el interés, convirtiendo visitantes en leads calificados.</div>
                        </div>
                    </div>
                    <div class="benefit">
                        <div class="benefit-num">3</div>
                        <div>
                            <div class="benefit-title">Mejora de imagen corporativa</div>
                            <div class="benefit-desc">Proyectar calidad y profesionalismo te posiciona como líder ante clientes, competidores y aliados estratégicos.</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="reveal-right">
                <div class="why-cta-box">
                    <div class="why-big">CTG</div>
                    <p class="section-eyebrow">Cartagena de Indias</p>
                    <h3 class="section-title" style="font-size:36px">PRESENCIA<br /><span class="accent">GARANTIZADA</span></h3>
                    <div class="stat-row">
                        <div class="s">
                            <div class="s-num">600+</div>
                            <div class="s-label">Marcas</div>
                        </div>
                        <div class="s">
                            <div class="s-num">5+</div>
                            <div class="s-label">Años</div>
                        </div>
                        <div class="s">
                            <div class="s-num">8</div>
                            <div class="s-label">Recintos</div>
                        </div>
                    </div>
    ...
    <div class="cta-full" id="cotizar">
        <div class="cta-wrap">
            <div>
                <div class="cta-eyebrow">¿Listo para destacar en Cartagena?</div>
            ...
            <div class="cta-actions">
                ...
                <a href="mailto:standsCartagena.web@gmail.com" class="btn-secondary">Enviar correo</a>
            </div>
        </div>
    </div>
    ...
    <footer>
        <div class="footer-inner">
            <div class="footer-brand">
                ...
                <p class="footer-tagline">Diseñamos stands que hacen destacar tu marca en ferias y eventos en Cartagena de Indias.</p>
            </div>
