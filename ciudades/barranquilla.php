...
<head>
    ...
    <meta
        name="description"
        content="Diseño y fabricación de stands para ferias y eventos en Barranquilla. Presencia en Puerta de Oro, Corferias y más. Cotiza hoy." />
    ...
    <section class="about-section" id="nosotros">
        <div class="about-grid">
            <div class="reveal-left">
                ...
                <p class="section-sub">
                    Llevamos la misma calidad que nos hace líderes en Cartagena a la capital del Atlántico. Equipo
                    local, tiempos garantizados y diseño de primera.
                </p>
                <div class="about-features">
                    <div class="feat">
                        ...
                        <div>
                            ...
                            <div class="feat-desc">
                                Conocemos los principales centros de eventos de Barranquilla y sus reglamentos
                                específicos.
                            </div>
                        </div>
                    </div>
                    <div class="feat">
                        ...
                        <div>
                            ...
                            <div class="feat-desc">
                                Para eventos de corto plazo, ofrecemos soluciones modulares listas en 48 horas.
                            </div>
                        </div>
                    </div>
                    <div class="feat">
                        ...
                        <div>
                            ...
                            <div class="feat-desc">
                                Visualiza tu stand antes de construirlo con renders fotorrealistas incluidos.
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="process-section" id="proceso">
        <div class="process-wrap">
            <div class="process-header reveal">
                ...
                <p class="section-sub">
                    Proceso claro y transparente para transformar tu idea en un stand impactante.
                </p>
            </div>
            <div class="steps">
                    ...
                    <div class="benefit">
                        ...
                        <div>
                            ...
                            <div class="benefit-desc">
                                Operamos directamente en Barranquilla con equipo local que conoce los recintos,
                                reglamentos y proveedores de la región.
                            </div>
                        </div>
                    </div>
                    <div class="benefit">
                        ...
                        <div>
                            ...
                            <div class="benefit-desc">
                                Cumplimos con cada fecha de entrega. Nuestros procesos están optimizados para que tu
                                stand esté listo cuando lo necesitas.
                            </div>
                        </div>
                    </div>
                    <div class="benefit">
                        ...
                        <div>
                            ...
                            <div class="benefit-desc">
                                Experiencia demostrada en los principales eventos empresariales del Caribe
                                colombiano.
                            </div>
                        </div>
                    </div>
            ...
            <div class="reveal-right">
                <div class="why-cta-box">
                    ...
                    <h3 class="section-title" style="font-size: 36px">
                        PRESENCIA<br /><span class="accent">EN EL</span> CARIBE
                    </h3>
                    <div class="stat-row">
                        <div class="s">
                            <div class="s-num">5+</div>
                            <div class="s-label">Recintos BARRANQUILLA</div>
                        </div>
                        <div class="s">
        ...
        <div class="cta-wrap">
            <div>
                ...
                <div class="cta-title">
                    ...
                    <span style="color: var(--blue-light)">EN BARRANQUILLA</span>
                </div>
